...
(** tipos para as expressões regulares*)
type regexp =
  | V  
  | E
  | C of char
  ...
  (** ignorar esta parte do programa *)
 ...
 (* função de transformação de uma string para regexp *)
 let regexp st =
 ...
 (* um utilitário, para fins de exemplo  *)
